...
CREATE TABLE XFCSTMASTERDETAILS (
        ...
        CATENTRY_ID BIGINT,
        LEAD_TIME SMALLINT,
        COVERED_FLAG SMALLINT,
        CONSTRAINED_FLAG SMALLINT,
        NO_FCST_QTY_FLAG SMALLINT,
        FORECAST_RCV_DATE DATE,
        UPDATED_ON TIMESTAMP,
        VMI CHAR(1),
        PLANT_INVENTORY INTEGER,
        WERKS VARCHAR(4),
        CONSIGN_INV INTEGER
    );

CREATE TABLE PRELEMENTATTR (
        PRELEMENT_ID INTEGER NOT NULL,
...
CREATE TABLE PRELEMENT (
        ...
        PRELETEMPLATE_ID INTEGER NOT NULL,
        PRICERULE_ID INTEGER NOT NULL,
        PARENT VARCHAR(64),
...
CREATE TABLE XORDERITEMS (
        ...
        AVN_AVLQUANTITY INTEGER,
        BONDED_AVLQUANTITY INTEGER,
        FACTORY_AVLQUANTITY INTEGER,
        LEADTIME INTEGER,
        LEADTIME_UOM CHAR(1),
        FIELD1 INTEGER,
        FIELD2 VARCHAR(254),
...
CREATE TABLE PLWIDGETNVP (
        PLWIDGETNVP_ID INTEGER NOT NULL,
        PLWIDGET_ID INTEGER NOT NULL,
...
CREATE TABLE PLWIDGETSLOT (
        PLWIDGETSLOT_ID INTEGER NOT NULL,
        PAGELAYOUT_ID INTEGER NOT NULL,
        PLWIDGET_ID INTEGER NOT NULL,
...
CREATE TABLE DSR_SALES_ORDER (
        ...
        ORDER_CHANGE_AUDIT_KEY INTEGER,
...
CREATE TABLE PLWIDGETREL (
        PLWIDGET_ID_PARENT INTEGER,
        PLWIDGET_ID_CHILD INTEGER NOT NULL,
        SEQUENCE INTEGER,
        OPTCOUNTER SMALLINT NOT NULL
    );
...
CREATE TABLE PLWIDGET (
        PLWIDGET_ID INTEGER NOT NULL,
        PAGELAYOUT_ID INTEGER NOT NULL,
        PLWIDGETDEF_ID INTEGER NOT NULL,
        ADMINNAME VARCHAR(256) NOT NULL,
        SLOTID VARCHAR(64),
        FIELD1 INTEGER,
        FIELD2 VARCHAR(256),
...
CREATE TABLE EMSPOT (
        ...
        UIDISPLAYABLE INTEGER,
        MANAGINGTOOL INTEGER
    );
ALTER TABLE EMSPOT ADD COLUMN USAGETYPE VARCHAR(20) NOT NULL;
ALTER TABLE EMSPOT ADD COLUMN UIDISPLAYABLE INTEGER;
ALTER TABLE EMSPOT ADD COLUMN USAGETYPE MANAGINGTOOL INTEGER;

ALTER TABLE DMEMSPOTDEF ADD COLUMN SEQUENCE INTEGER NOT NULL;

ALTER TABLE COLLATERAL ADD COLUMN BEHAVIOR NUMBER NOT NULL;
ALTER TABLE COLLATERAL ADD COLUMN UIDISPLAYABLE INTEGER;
ALTER TABLE COLLATERAL ADD COLUMN MANAGINGTOOL INTEGER;
ALTER TABLE COLLATERAL ADD COLUMN OVRMKTLIMIT INTEGER;
...
CREATE TABLE SRCHPROPRELV (
        ...
        RELVALUE INTEGER NOT NULL,
        INDEXFIELD VARCHAR(128),
        OPTCOUNTER SMALLINT NOT NULL
    );

ALTER TABLE ATTR ADD COLUMN ATTRUSAGE SMALLINT;  
ALTER TABLE ATTR ADD COLUMN STOREDISPLAY SMALLINT;
ALTER TABLE ATTR ADD COLUMN FACETABLE SMALLINT;
ALTER TABLE ATTR ADD COLUMN MERCHANDISABLE SMALLINT;

CREATE TABLE ATTRDICTSRCHCONF (
        ATTRDICTSRCHCNF_ID BIGINT NOT NULL,
        MASTERCATALOG_ID INTEGER NOT NULL,
...
CREATE TABLE FACET (
 ...
 ALTER TABLE CATGROUP ADD COLUMN DYNAMIC INTEGER;
...
CREATE TABLE XBOMUPLOADDATA (
        XBOMUPLOADDATAID INTEGER NOT NULL,
...
ALTER TABLE DMACTIVITY ADD COLUMN BEHAVIOR INTEGER NOT NULL;
ALTER TABLE DMACTIVITY ADD COLUMN UIDISPLAYABLE SMALLINT;
ALTER TABLE DMACTIVITY ADD COLUMN MANAGINGTOOL SMALLINT;

CREATE TABLE BRANCH_ZIP (
        BRANCH_ZIP_ID INTEGER NOT NULL,
        BRANCH_ID VARCHAR(4),
...
CREATE TABLE PLLOCATION (
        PLLOCATION_ID INTEGER NOT NULL,
        PAGELAYOUT_ID BIGINT NOT NULL,
...
CREATE TABLE XMSG (
        ...
        STOREENT_ID DECIMAL(38 , 0) NOT NULL,
...
CREATE TABLE SEOPAGEDEFDESC (
        SEOPAGEDEF_ID INTEGER NOT NULL,
        LANGUAGE_ID SMALLINT NOT NULL,
        TITLE VARCHAR(254),
...
CREATE TABLE PLPAGE (
        ...
        ADMINNAMEEDITABLE SMALLINT NOT NULL,
        URLCONFIGURABLE SMALLINT NOT NULL,
        FIELD1 INTEGER,
        FIELD2 VARCHAR(256),
        FIELD3 VARCHAR(256),
        OPTCOUNTER SMALLINT NOT NULL
...
CREATE TABLE SEOPAGEDEFOVR (
        ...
        APPLY_TO_CHILD SMALLINT NOT NULL,
...
CREATE TABLE CFCONDGRP (
        ...
        CFCATGROUP_ID BIGINT NOT NULL,
        IDENTIFIER VARCHAR(254) NOT NULL,
        CONDITIONRELATION INTEGER NOT NULL,
        FIELD1 INTEGER,
        FIELD2 INTEGER,
        FIELD3 VARCHAR(254),
        FIELD4 DECIMAL(20 , 5),
...
CREATE TABLE XFORM_RESALE_ADDRESS (
        ...
        STORE_ID INTEGER NOT NULL,
        FORM_QUESTION_ID INTEGER NOT NULL,
        FORM_RESALE_ADDRESS_ID INTEGER NOT NULL,
        FORM_RESPONSE_ID INTEGER NOT NULL,
...
CREATE TABLE WALLETITEM (
        WALLETITEM_ID INTEGER NOT NULL,
...
CREATE TABLE PLSTOREWIDGET (
        PLSTOREWIDGET_ID INTEGER NOT NULL,
        STOREENT_ID INTEGER NOT NULL,
        PLWIDGETDEF_ID INTEGER NOT NULL,
        STATE SMALLINT NOT NULL,
        DEFINITIONXML CLOB,
...
CREATE TABLE PX_CDPOOL (
        ...
        STATUS SMALLINT NOT NULL,
        TRANSFERABLE SMALLINT NOT NULL,
        VALIDFROM TIMESTAMP,
...
CREATE TABLE PX_CDUSAGE (
        PX_CDUSAGE_ID INTEGER NOT NULL,
        PX_CDPOOL_ID BIGINT NOT NULL,
        OWNER_ID INTEGER,
        ORDERS_ID INTEGER,
        STATUS SMALLINT,
...
CREATE TABLE CLSATTRSRCHCONF (
        CLSATTRSRCHCONF_ID INTEGER NOT NULL,
        MASTERCATALOG_ID INTEGER NOT NULL,
        SRCHFIELDNAME VARCHAR(18) NOT NULL,
...
CREATE TABLE XFORM_OPTION (
        ...
        FORM_VERSION_ID INTEGER NOT NULL,
        FORM_QUESTION_ID INTEGER NOT NULL,
        FORM_OPTION_ID INTEGER NOT NULL,
        SORT_ORDER_NO INTEGER NOT NULL,
        DEPENDENT_QUESTION_SET_ID INTEGER
    );
