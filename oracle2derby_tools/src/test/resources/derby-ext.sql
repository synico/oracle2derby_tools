...
ALTER TABLE ORGENTITY ALTER COLUMN FIELD1 SET DATA TYPE VARCHAR(256);
ALTER TABLE SCHBRDCST ALTER COLUMN CLONEID SET DATA TYPE VARCHAR(256) NOT NULL;
...
ALTER TABLE ORDPROMOCD ALTER COLUMN OPTCOUNTER SET DATA TYPE INTEGER;
ALTER TABLE SRCHCONFEXT ALTER COLUMN LANGUAGE_ID SET DATA TYPE INTEGER DEFAULT -1;
