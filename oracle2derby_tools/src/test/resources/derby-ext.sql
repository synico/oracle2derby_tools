...
ALTER TABLE EMSPOT ADD COLUMN USAGETYPE VARCHAR(20);
...
ALTER TABLE COLLATERAL ADD COLUMN BEHAVIOR DECIMAL(20,0);
...
ALTER TABLE DMACTIVITY ADD COLUMN BEHAVIOR DECIMAL(20,0);
