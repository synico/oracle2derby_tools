...
public class CATENCALCD {
    ...
    private java.math.BigDecimal CATENCALCD_ID;
    
    public void setCATENCALCD_ID(java.math.BigDecimal CATENCALCD_ID) {
        this.CATENCALCD_ID = CATENCALCD_ID;
    }
    
    public java.math.BigDecimal getCATENCALCD_ID() {
        return this.CATENCALCD_ID;
    }
    ...
    public String toString() {
        ...
        result.append("CATENCALCD_ID: " + getCATENCALCD_ID() + "||");
