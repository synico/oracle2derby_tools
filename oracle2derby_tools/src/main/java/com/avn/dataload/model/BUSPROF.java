...
public class BUSPROF {
    ...
    private java.math.BigDecimal ORG_ID;
    
    public void setORG_ID(java.math.BigDecimal ORG_ID) {
        this.ORG_ID = ORG_ID;
    }
    
    public java.math.BigDecimal getORG_ID() {
        return this.ORG_ID;
    }
      

    private java.math.BigDecimal ORGUNIT_ID;
    
    public void setORGUNIT_ID(java.math.BigDecimal ORGUNIT_ID) {
        this.ORGUNIT_ID = ORGUNIT_ID;
    }
    
    public java.math.BigDecimal getORGUNIT_ID() {
    ...
    public void setDEPARTMENTNUM(java.lang.String DEPARTMENTNUM) {
        this.DEPARTMENTNUM = DEPARTMENTNUM;
    }
    
    public java.lang.String getDEPARTMENTNUM() {
        return this.DEPARTMENTNUM;
    }
      

    private java.lang.String ALTERNATEID;
    ...
    private java.lang.String SECRETARY;
    
    public void setSECRETARY(java.lang.String SECRETARY) {
