...
public class DMACTIVITY {
    ...
    private java.math.BigDecimal REPEATABLE;
    
    public void setREPEATABLE(java.math.BigDecimal REPEATABLE) {
        this.REPEATABLE = REPEATABLE;
    }
    
    public java.math.BigDecimal getREPEATABLE() {
    ...
    private java.sql.Clob FLOWXML;
    
    public void setFLOWXML(java.sql.Clob FLOWXML) {
        this.FLOWXML = FLOWXML;
    }
    
    public java.sql.Clob getFLOWXML() {
        return this.FLOWXML;
    }
