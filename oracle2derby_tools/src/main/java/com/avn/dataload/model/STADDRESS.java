...
public class STADDRESS {
    ...
    public void setSTADDRESS_ID(java.math.BigDecimal STADDRESS_ID) {
        this.STADDRESS_ID = STADDRESS_ID;
    }
    
    public java.math.BigDecimal getSTADDRESS_ID() {
        return this.STADDRESS_ID;
    }
