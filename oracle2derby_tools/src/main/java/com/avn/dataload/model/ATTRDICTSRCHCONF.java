...
public class ATTRDICTSRCHCONF {
    ...
    public void setATTRDICTSRCHCNF_ID(java.math.BigDecimal ATTRDICTSRCHCNF_ID) {
        this.ATTRDICTSRCHCNF_ID = ATTRDICTSRCHCNF_ID;
    }
    
    public java.math.BigDecimal getATTRDICTSRCHCNF_ID() {
        return this.ATTRDICTSRCHCNF_ID;
    }
