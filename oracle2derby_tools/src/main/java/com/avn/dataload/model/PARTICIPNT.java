...
public class PARTICIPNT {
    ...
    public void setPARTICIPNT_ID(java.math.BigDecimal PARTICIPNT_ID) {
        this.PARTICIPNT_ID = PARTICIPNT_ID;
    }
    
    public java.math.BigDecimal getPARTICIPNT_ID() {
        return this.PARTICIPNT_ID;
    }
