...
public class DMELEMENT {
    ...
    private java.math.BigDecimal RELATED_ID;
    
    public void setRELATED_ID(java.math.BigDecimal RELATED_ID) {
        this.RELATED_ID = RELATED_ID;
    }
    
    public java.math.BigDecimal getRELATED_ID() {
    ...
    public String toString() {
        ...
        result.append("RELATED_ID: " + getRELATED_ID() + "||");
