...
public class CALCODE {
    ...
    private java.math.BigDecimal GROUPBY;
    
    public void setGROUPBY(java.math.BigDecimal GROUPBY) {
        this.GROUPBY = GROUPBY;
    }
    
    public java.math.BigDecimal getGROUPBY() {
        return this.GROUPBY;
    }
      

    private java.math.BigDecimal TXCDCLASS_ID;
    
    public void setTXCDCLASS_ID(java.math.BigDecimal TXCDCLASS_ID) {
        this.TXCDCLASS_ID = TXCDCLASS_ID;
    }
    
    public java.math.BigDecimal getTXCDCLASS_ID() {
        return this.TXCDCLASS_ID;
    }
    ...
    private java.math.BigDecimal DISPLAYLEVEL;
    
    public void setDISPLAYLEVEL(java.math.BigDecimal DISPLAYLEVEL) {
        this.DISPLAYLEVEL = DISPLAYLEVEL;
    }
    
    public java.math.BigDecimal getDISPLAYLEVEL() {
