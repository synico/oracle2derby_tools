...
public class SCHACTIVE {
    ...
    private java.math.BigDecimal SCSPRIORITY;
    
    public void setSCSPRIORITY(java.math.BigDecimal SCSPRIORITY) {
        this.SCSPRIORITY = SCSPRIORITY;
    }
    
    public java.math.BigDecimal getSCSPRIORITY() {
        return this.SCSPRIORITY;
    }
