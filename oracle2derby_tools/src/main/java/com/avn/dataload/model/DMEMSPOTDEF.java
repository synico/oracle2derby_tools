...
public class DMEMSPOTDEF {
    ...
    public void setDMEMSPOTDEF_ID(java.math.BigDecimal DMEMSPOTDEF_ID) {
        this.DMEMSPOTDEF_ID = DMEMSPOTDEF_ID;
    }
    
    public java.math.BigDecimal getDMEMSPOTDEF_ID() {
        return this.DMEMSPOTDEF_ID;
    }
