...
public class LANGPAIR {
    ...
    private java.math.BigDecimal LANGUAGE_ID_ALT;
    
    public void setLANGUAGE_ID_ALT(java.math.BigDecimal LANGUAGE_ID_ALT) {
        this.LANGUAGE_ID_ALT = LANGUAGE_ID_ALT;
    }
    
    public java.math.BigDecimal getLANGUAGE_ID_ALT() {
        return this.LANGUAGE_ID_ALT;
    }
    ...
    public String toString() {
        ...
        result.append("LANGUAGE_ID_ALT: " + getLANGUAGE_ID_ALT() + "||");
