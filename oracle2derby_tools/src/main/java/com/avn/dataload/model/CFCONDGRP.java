...
public class CFCONDGRP {
    ...
    private java.math.BigDecimal CFCONDGRP_ID;
    
    public void setCFCONDGRP_ID(java.math.BigDecimal CFCONDGRP_ID) {
        this.CFCONDGRP_ID = CFCONDGRP_ID;
    }
    
    public java.math.BigDecimal getCFCONDGRP_ID() {
        return this.CFCONDGRP_ID;
    }
    ...
    private java.math.BigDecimal CONDITIONRELATION;
    
    public void setCONDITIONRELATION(java.math.BigDecimal CONDITIONRELATION) {
        this.CONDITIONRELATION = CONDITIONRELATION;
    }
    
    public java.math.BigDecimal getCONDITIONRELATION() {
    ...
    public String toString() {
        ...
        result.append("CFCONDGRP_ID: " + getCFCONDGRP_ID() + "||");
        result.append("CFCATGROUP_ID: " + getCFCATGROUP_ID() + "||");
        result.append("IDENTIFIER: " + getIDENTIFIER() + "||");
        result.append("CONDITIONRELATION: " + getCONDITIONRELATION() + "||");
