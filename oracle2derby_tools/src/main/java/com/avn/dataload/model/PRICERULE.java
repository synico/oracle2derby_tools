...
public class PRICERULE {
    ...
    private java.math.BigDecimal DEPENDENT;
    
    public void setDEPENDENT(java.math.BigDecimal DEPENDENT) {
        this.DEPENDENT = DEPENDENT;
    }
    
    public java.math.BigDecimal getDEPENDENT() {
    ...
    public String toString() {
        ...
        result.append("DEPENDENT: " + getDEPENDENT() + "||");
