...
public class XFORM_QUESTION_SET_REL {
    ...
    private java.math.BigDecimal CSS_STYLE_TX;
    
    public void setCSS_STYLE_TX(java.math.BigDecimal CSS_STYLE_TX) {
        this.CSS_STYLE_TX = CSS_STYLE_TX;
    }
    
    public java.math.BigDecimal getCSS_STYLE_TX() {
        return this.CSS_STYLE_TX;
    }
