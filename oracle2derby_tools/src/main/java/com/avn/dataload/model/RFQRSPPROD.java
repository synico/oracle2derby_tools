...
public class RFQRSPPROD {
    ...
    private java.math.BigDecimal RFQCATENTRYID;
    
    public void setRFQCATENTRYID(java.math.BigDecimal RFQCATENTRYID) {
        this.RFQCATENTRYID = RFQCATENTRYID;
    }
    
    public java.math.BigDecimal getRFQCATENTRYID() {
        return this.RFQCATENTRYID;
    }
    ...
    private java.math.BigDecimal SKUGENFLAG;
    
    public void setSKUGENFLAG(java.math.BigDecimal SKUGENFLAG) {
        this.SKUGENFLAG = SKUGENFLAG;
    }
    
    public java.math.BigDecimal getSKUGENFLAG() {
        return this.SKUGENFLAG;
    }
