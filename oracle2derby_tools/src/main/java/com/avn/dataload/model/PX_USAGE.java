...
public class PX_USAGE {


    private java.math.BigDecimal PX_USAGE_ID;
    
    public void setPX_USAGE_ID(java.math.BigDecimal PX_USAGE_ID) {
        this.PX_USAGE_ID = PX_USAGE_ID;
    }
    
    public java.math.BigDecimal getPX_USAGE_ID() {
        return this.PX_USAGE_ID;
    }
    ...
    public String toString() {
        ...
        result.append("PX_USAGE_ID: " + getPX_USAGE_ID() + "||");
